...
//	                  break;
	              ...
	              VerifyOrReturnError(TLVError != CHIP_NO_ERROR,  CHIP_ERROR_IM_MALFORMED_COMMAND_DATA_ELEMENT);
...
//	                    break;
            ...
            if(false == seenProfile) {
                ...
                std::cout << "first seen Profile\n";
            } else {
                if(currentVendorId != vendorId || currentProfileNum != profileNum) {
                    std::cout << "error on ids\n " ;
                    // is this an error condition?
	               return CHIP_ERROR_IM_MALFORMED_COMMAND_DATA_ELEMENT;
                }
            }
            tagNum = TLV::TagNumFromTag(tag);
            std::cout << "VendorId: " << currentVendorId << " ProfileNum: " <<currentProfileNum << 
                    " tagNum = " << tagNum << "\n";
